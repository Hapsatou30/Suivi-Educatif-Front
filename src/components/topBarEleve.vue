...
const fetchProfile = async () => {
  try {
    ...
    formData.value.email = user.email;
     photoUser.value = `https://suivieducatifapi.thiamhapstou.simplonfabriques.com/storage//` + user.eleve.photo || 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTF5-3YjBcXTqKUlOAeUUtuOLKgQSma2wGG1g&s'; 
  }
