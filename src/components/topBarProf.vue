...
const fetchProfile = async () => {
  try {
    ...
    photoUser.value = `suiviEducatifAPI.thiamhapstou.simplonfabriques.com/storage//` + user.professeur.photo || 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTF5-3YjBcXTqKUlOAeUUtuOLKgQSma2wGG1g&s'; 
